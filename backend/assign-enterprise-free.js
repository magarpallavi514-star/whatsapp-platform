...
async function assignEnterpriseSubscription() {
  try {
    ...
    const enterprisePlan = await PricingPlan.findOne({ 
      name: 'Enterprise',
      isActive: true 
    });
    ...
    console.log('📌 Found Enterprise Plan:');
    ...
    if (existingSubscription) {
      ...
      existingSubscription.planId = enterprisePlan._id;
    ...
    console.log('═'.repeat(60));
    console.log('\n✅ Enromatics now has Enterprise plan with 100% discount!\n');
